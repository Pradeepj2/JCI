	...
	<div class="page-wrapper">
		...
		<div class="content-wrapper">
			...
			<div class="page-heading">
				<h1 class="page-title">Entry of PCSO (Production Control cum
					Supply Order)</h1>
			</div>
								...
								<form action="entryofpcsosave.obj" method="POST">
									<div class="row">
										<div class="col-sm-3 form-group">
											<label>JCI Ref.No.</label> <input class="form-control"
									...
									<div class="row">
										<div class="col-sm-3 form-group">
											<label>JCI Jute Ratio.</label> <input class="form-control"
												type="number" name="juteRatio" id="juteRatio" min="0"
												required>
										</div>
										<div class="col-sm-3 form-group">
											<label>PCSO Qty. (M.T)</label> <input class="form-control"
												name="pcsoQty" id="pcsoQty" value="<%=referencedateVal%>"
												readonly>
										</div>
