...
<body class="fixed-navbar">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
								...
								<tbody>
									...
									<tr>
                                     ...
                                     <td><a onclick="saveCreditNote('<%=ele[1]%>','<%=ele[3]%>','<%=ele[4]%>','<%=ele[5]%>','<%=ele[2]%>')" class="btn btn-warning btn-sm btn-block">Generate credit Note </a></td>  
    ...
    <script type="text/javascript">
      ...
      function saveCreditNote(shipmentDetails , nominalWeight , ActualWeight , roId , invoiceVal){
