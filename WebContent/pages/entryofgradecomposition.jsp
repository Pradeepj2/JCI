						...
						<div class="ibox">
							...
							<div class="ibox-body">
								<form action="saveGradeComp.obj" method="POST">
										...
										<table>
											<thead>
												<tr class="row">
													...
													<th class="col-sm-3 " scope="col">Proposed Composition</th>
												</tr>
											</thead>
											<tbody>
									...
									<div>
										<button class="btn btn-success" id="disableButton"
