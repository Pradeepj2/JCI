											...
											<table>
												...
												<tr>
													...
													<td><input type="number" name="tgr1" id="tgr1"
														...
														data-decimal="2" min="0"
														oninput="enforceNumberValidation(this)" /></td>
													<td><input type="number" name="tgr2" id="tgr2"
														step="any" data-decimal="2"
														oninput="enforceNumberValidation(this)" min="0"
													...
													<td><input type="number" name="tgr5" id="tgr5"
														...
														oninput="enforceNumberValidation(this)" min="0"
														class="form-control validation" /></td>
													<td><small id="errEmailtgr" name="errEmailtgr"
												...
												<tr>
													...
													<td><input type="number" name="wgr5" id="wgr5"
														...
														oninput="enforceNumberValidation(this)" min="0"
														class="form-control validation" /></td>
													<td><small id="errEmailwgr" name="errEmailwgr"
														class="text-danger"></small></td>
												</tr>
												<tr>
													<td>Mesta</td>
													...
													<td><input type="number" name="mgr6" id="mgr6"
														...
														oninput="enforceNumberValidation(this)" min="0"
														class="form-control validation" /></td>
													<td><small id="errEmailmgr" name="errEmailmgr"
														class="text-danger"></small></td>
												</tr>
												<tr>
													<td>Bimli</td>
													...
													<td><input type="number" name="bgr6" id="bgr6"
														...
														oninput="enforceNumberValidation(this)" min="0"
														class="form-control validation" /></td>
													<td><small id="errEmailbgr" name="errEmailbgr"
														class="text-danger"></small></td>
												</tr>
											</table>
										</div>
